...
export default function ClientOngoingProjects() {
  ...
  if (loading) {
    return (
      <div className="w-full bg-gradient-to-br bg-[#121212] flex justify-center items-center">
  ...
  return (
    <div className=" w-full overflow-y-auto bg-gradient-to-br bg-[#121212] text-gray-100">
      {/* Toast Container */}
