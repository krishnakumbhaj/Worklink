...
const JobCard = () => {
    ...
    return (
      <div className="min-h-screen w-full bg-zinc-950 flex items-center justify-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-zinc-300 text-lg">Loading opportunities...</p>
        </div>
      </div>
    );
  }
  ...
  if (jobs.length === 0) {
    return (
      <div className="min-h-screen bg-zinc-800 flex items-center justify-center">
        <div className="bg-zinc-800 rounded-xl p-8 max-w-md text-center border border-zinc-800">
          <Briefcase className="w-16 h-16 text-zinc-500 mb-4 mx-auto" />
          <p className="text-xl font-medium text-zinc-200 mb-2">No jobs available at the moment</p>
  ...
  return (
    <div className=" w-full bg-zinc-900 text-white overflow-y-auto">
      {/* Header */}
      <div className=" border-zinc-800 py-5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-center bg-gradient-to-r from-purple-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent mb-4">
            Explore Open Positions
          </h1>
          <p className="text-zinc-400 text-center text-sm">Discover your next career move with exciting opportunities</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {jobs.map((job) => (
            <div
              key={job._id}
              className="bg-zinc-800 rounded-2xl border border-zinc-800 hover:border-zinc-700 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/5 overflow-hidden group hover:scale-[1.02]"
            >
              {/* Card Header */}
              <div className="p-6 pb-4">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    <h2 className="text-xl font-bold text-white group-hover:text-purple-300 transition-colors mb-2 line-clamp-2">
                      {job.title}
                    </h2>
                  ...
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    ...
                    {job.description && job.description.length > 120 && (
                      <button
                        ...
                        className="text-purple-400 hover:text-purple-300 ml-2 inline-flex items-center text-xs font-medium transition-colors"
                      >
                        Read more
              ...
              <div className="p-6 pt-4 border-t border-zinc-800">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-3 ml-auto">
                    <button
                      onClick={() => setSelectedJob(job)}
                      className="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-4 py-2 rounded-3xl text-sm font-medium transition-colors duration-200 border border-zinc-700 hover:border-zinc-600"
                    >
                      View Details
                    </button>
                    <button
                      onClick={() => handleApply(job._id)}
                      className="bg-gradient-to-r from-purple-600 to-purple-600 hover:from-purple-700 hover:to-purple-700 text-white px-4 py-2 rounded-3xl text-sm font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
                    >
                      Apply 
                    </button>
                  </div>
      ...
      {selectedJob && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-zinc-800 rounded-2xl border border-zinc-800 max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            {/* Modal Header */}
            ...
            <div className="p-8 space-y-8">
              ...
              <div>
                ...
                <p className="text-zinc-300 leading-relaxed text-base bg-zinc-800/50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-zinc-200">{selectedJob.location}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-zinc-400 mb-1">Salary</p>
                      <p className="font-semibold text-zinc-200">{selectedJob.salary || 'Not specified'}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-zinc-200">{selectedJob.experienceLevel}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <Briefcase className="w-5 h-5 mr-3 text-purple-400 mt-1" />
                    <div>
                      <p className="text-sm text-zinc-400 mb-1">Job Type</p>
                      <p className="font-semibold text-zinc-200">{selectedJob.type}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm text-zinc-400 mb-1">Work Mode</p>
                      <p className="font-semibold text-zinc-200">{selectedJob.remoteOption}</p>
                    </div>
                  </div>
                  ...
                  {selectedJob.applicationDeadline && (
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-sm text-zinc-400 mb-1">Application Deadline</p>
                        <p className="font-semibold text-zinc-200">{formatDate(selectedJob.applicationDeadline)}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              {selectedJob.requirements && (
                <div>
                  ...
                  <div className="bg-zinc-800/50 p-4 rounded-lg">
                    <p className="text-zinc-300 leading-relaxed">{selectedJob.requirements}</p>
                  </div>
                </div>
              )}
              ...
              {selectedJob.benefits && (
                <div>
                  ...
                  <div className="bg-zinc-800/50 p-4 rounded-lg">
                    <p className="text-zinc-300 leading-relaxed">{selectedJob.benefits}</p>
                  </div>
                </div>
              )}
              ...
              <div className="flex items-center justify-between pt-6 border-t border-zinc-800">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-purple-600 to-purple-600 hover:from-purple-700 hover:to-purple-700 text-white px-8 py-3 rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  Apply 
                </button>
              </div>
